...
import (
	...
	"github.com/EugeneTorap/go-pg-migrate/source"
...
func NewWithDatabaseInstance(sourceURL string, databaseName string, databaseInstance Driver) (*Migrate, error) {
	m := newCommon()
...
func NewWithSourceInstance(sourceName string, sourceInstance source.Driver, databaseURL string) (*Migrate, error) {
	...
	databaseDrv, err := Open(databaseURL)
	if err != nil {
		return nil, err
	}
...
func NewWithInstance(sourceName string, sourceInstance source.Driver, databaseName string, databaseInstance Driver) (*Migrate, error) {
	m := newCommon()
